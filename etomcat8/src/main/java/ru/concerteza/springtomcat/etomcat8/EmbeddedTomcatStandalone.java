 ...
 * Date: 12/3/14
 */
public class EmbeddedTomcatStandalone {
    private final Log logger = LogFactory.getLog(EmbeddedTomcatStandalone.class);
    ...
    public synchronized EmbeddedTomcatStandalone start(File baseDir) {
...
//        proto.setUseExecutor(true);
    ...
    public EmbeddedTomcatStandalone setGeneralProps(GeneralProperties generalProps) {
        this.generalProps = generalProps;
        return this;
    }

    public EmbeddedTomcatStandalone setFsProps(FsProperties fsProps) {
        this.fsProps = fsProps;
        return this;
    }

    public EmbeddedTomcatStandalone setHostProps(HostProperties hostProps) {
        this.hostProps = hostProps;
        return this;
    }

    public EmbeddedTomcatStandalone setContextProps(ContextProperties contextProps) {
        this.contextProps = contextProps;
        return this;
    }

    public EmbeddedTomcatStandalone setConnectorProps(ConnectorProperties connectorProps) {
        this.connectorProps = connectorProps;
        return this;
    }

    public EmbeddedTomcatStandalone setNioProps(NioProperties nioProps) {
        this.nioProps = nioProps;
        return this;
    }

    public EmbeddedTomcatStandalone setSocketProps(SocketProperties socketProps) {
        this.socketProps = socketProps;
        return this;
    }

    public EmbeddedTomcatStandalone setSslProps(SslProperties sslProps) {
        this.sslProps = sslProps;
        return this;
    }

    public EmbeddedTomcatStandalone setExecutorProps(ExecutorProperties executorProps) {
